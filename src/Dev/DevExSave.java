...
public class DevExSave {
	...
	public String edit() throws Exception{
		...
		try {
		      ...
		      if(rs.next()){
		    	  stmt.executeUpdate("update dev_data set language='"+inputLanguage+"' where Account='"+inputAccount+"'");
		    	  stmt.executeUpdate("update dev_data set platform='"+inputPlatform+"' where Account='"+inputAccount+"'");
		    	  stmt.executeUpdate("update dev_data set experience='"+inputExperience+"' where Account='"+inputAccount+"'");
		      }  
		} 
		catch (Exception e) {
